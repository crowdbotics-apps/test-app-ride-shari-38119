...
## Project Structure
    ...
    ├── test_app_ride_shari_38119  # Django project configurations
...
1. Clone this repo and `cd test_app_ride_shari_38119`
...
2. Clone this repo and `cd test_app_ride_shari_38119`
